...
urlpatterns = [
    ...
    path('api/register/student/', app_views.register_student_api, name='register_student_api'),
    path('api/upload-face-images/', app_views.upload_face_images, name='upload_face_images'),
